...
function Form() {
    ...
    const { ownerSetter, getRepoData, apiToUse, apiToUseSetter, type, selectTypeFilter, sort, selectSort, repoData } = useRepo();
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit, onError)}>
            <input
                {...register('owner', { required: true, onChange: (e) => handleOnOwner(e) })}
                placeholder=""
            />
            <select {...register('apiToUse', {onChange: (e) => handleOnApiToUse(e)})}>
            ...
            <select {...register('direction', {onChange: (e) => handleOnDirection(e)})}>
